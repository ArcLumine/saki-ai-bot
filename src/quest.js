...
/**
 * 题材素材池 —— 从**人设包里的 `quest-ideas.md`** **现读**（2026-09-18 用户要求「挪吧」；2026-09-23 起在 `personas/<id>/`）。
 *
...
6d. ⚠️⚠️ **绝不许编"具体的凭证"，也不许靠它推进剧情**（2026-09-18 用户截图报的）：
   · 真实事故：剧情走到"得打个电话"，她就在群里报了「**<示例手机号>**，快打」——
...
function buildSystem(extra = '') {
  ...
  return [
    ...
    QUEST_SYSTEM,
    // ⚠️ 素材池**现读现拼**（2026-09-18 挪到人设包、2026-09-23 起在 `personas/<id>/quest-ideas.md`：
